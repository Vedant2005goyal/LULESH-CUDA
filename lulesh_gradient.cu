...
__attribute__((device)) __attribute__((always_inline)) static inline void
ApplyMaterialPropertiesForElems_device_pullback(
    Real_t eosvmin, Real_t eosvmax, const Real_t* __restrict vnew,
    const Real_t* __restrict v, Real_t& vnewc,
    const Index_t* __restrict bad_vol, Index_t zn, Real_t* _d_eosvmin,
    Real_t* _d_eosvmax, Real_t* _d_vnew, Real_t* _d_v, Real_t* _d_vnewc,
    Index_t* _d_bad_vol, Index_t* _d_zn) {
  bool _cond0;
  bool _cond1;
  bool _cond2;
  bool _cond3;
...
giveMyRegion_pullback(const Index_t* regCSR, const Index_t i,
                      const Index_t numReg, Index_t _d_y, Index_t* _d_regCSR,
                      Index_t* _d_i, Index_t* _d_numReg) {
  Index_t _d_reg = 0;
  Index_t reg = 0;
...
__attribute__((device)) __attribute__((host)) inline void
FABS_pullback(real8 arg, real8 _d_y, real8* _d_arg) {
  {
    real8 _r0 = 0.;
    _r0 +=
        _d_y * clad::custom_derivatives::fabs_pushforward(arg, 1.).pushforward;
    *_d_arg += _r0;
  }
}
__attribute__((device)) __attribute__((always_inline)) static inline void
CalcPressureForElems_device_pullback(
    Real_t& p_new, Real_t& bvc, Real_t& pbvc, Real_t e_old, Real_t compression,
    Real_t vnewc, Real_t pmin, Real_t p_cut, Real_t eosvmax, Real_t* _d_p_new,
    Real_t* _d_bvc, Real_t* _d_pbvc, Real_t* _d_e_old, Real_t* _d_compression,
    Real_t* _d_vnewc, Real_t* _d_pmin, Real_t* _d_p_cut, Real_t* _d_eosvmax) {
  bool _cond0;
  Real_t _t1;
  bool _cond1;
  Real_t _t2;
...
__attribute__((device)) inline void SQRT_pullback(real8 arg, real8 _d_y,
                                                  real8* _d_arg) {
  {
    real8 _r0 = 0.;
    _r0 +=
        _d_y * clad::custom_derivatives::sqrt_pushforward(arg, 1.).pushforward;
    *_d_arg += _r0;
  }
}
__attribute__((device)) __attribute__((always_inline)) static inline void
CalcEnergyForElems_device_pullback(
    ...
    Real_t rho0, Real_t eosvmax, Index_t length, Real_t* _d_p_new,
    Real_t* _d_e_new, Real_t* _d_q_new, Real_t* _d_bvc, Real_t* _d_pbvc,
    Real_t* _d_p_old, Real_t* _d_e_old, Real_t* _d_q_old,
    Real_t* _d_compression, Real_t* _d_compHalfStep, Real_t* _d_vnewc,
    Real_t* _d_work, Real_t* _d_delvc, Real_t* _d_pmin, Real_t* _d_p_cut,
    Real_t* _d_e_cut, Real_t* _d_q_cut, Real_t* _d_emin, Real_t* _d_qq,
    Real_t* _d_ql, Real_t* _d_rho0, Real_t* _d_eosvmax, Index_t* _d_length) {
  bool _cond0;
  bool _cond1;
  Real_t _d_ssc = 0.;
  Real_t ssc = 0.;
  ...
  e_new = e_new +
          Real_t(0.5) * delvc *
              (Real_t(3.) * (p_old + q_old) - Real_t(4.) * (pHalfStep + q_new));
  ...
  Real_t _t13 = e_new;
  e_new = e_new - (Real_t(7.) * (p_old + q_old) -
                   Real_t(8.) * (pHalfStep + q_new) + (p_new + q_tilde)) *
                      delvc * sixth;
  {
  ...
  if (_cond9) {
    ...
    }
    {
      ...
      *_d_p_new += vnewc * vnewc * bvc * _d_ssc1 / rho0;
      Real_t _r24 = _d_ssc1 * -((pbvc * e_new + vnewc * vnewc * bvc * p_new) /
                                (rho0 * rho0));
      *_d_rho0 += _r24;
    }
  }
  {
    ...
    Real_t _r22 = 0.;
    Real_t _r23 = 0.;
    CalcPressureForElems_device_pullback(_t16, _t17, _t18, e_new, compression,
                                         vnewc, pmin, p_cut, eosvmax,
                                         &*_d_p_new, &*_d_bvc, &*_d_pbvc, &_r18,
                                         &_r19, &_r20, &_r21, &_r22, &_r23);
    *_d_e_new += _r18;
    *_d_compression += _r19;
    *_d_vnewc += _r20;
    *_d_pmin += _r21;
  ...
  }
  {
    ...
    *_d_delvc += (Real_t(7.) * (p_old + q_old) -
                  Real_t(8.) * (pHalfStep + q_new) + (p_new + q_tilde)) *
                 -_r_d14 * sixth;
    _d_sixth += (Real_t(7.) * (p_old + q_old) -
                 Real_t(8.) * (pHalfStep + q_new) + (p_new + q_tilde)) *
                delvc * -_r_d14;
  }
  if (_cond5) {
    ...
    }
    {
      ...
      *_d_p_new += vnewc * vnewc * bvc * _d_ssc0 / rho0;
      Real_t _r16 = _d_ssc0 * -((pbvc * e_new + vnewc * vnewc * bvc * p_new) /
                                (rho0 * rho0));
      *_d_rho0 += _r16;
    }
  }
  {
    ...
    Real_t _r14 = 0.;
    Real_t _r15 = 0.;
    CalcPressureForElems_device_pullback(_t9, _t10, _t11, e_new, compression,
                                         vnewc, pmin, p_cut, eosvmax,
                                         &*_d_p_new, &*_d_bvc, &*_d_pbvc, &_r10,
  ...
  if (_cond1) {
    ...
    }
    {
      ...
      *_d_bvc += vhalf * vhalf * _d_ssc / rho0 * pHalfStep;
      ...
      Real_t _r8 = _d_ssc * -((pbvc * e_new + vhalf * vhalf * bvc * pHalfStep) /
                              (rho0 * rho0));
      *_d_rho0 += _r8;
    }
  }
  ...
  }
  {
    ...
    Real_t _r6 = 0.;
    CalcPressureForElems_device_pullback(
        _t1, _t2, _t3, e_new, compHalfStep, vnewc, pmin, p_cut, eosvmax,
        &_d_pHalfStep, &*_d_bvc, &*_d_pbvc, &_r1, &_r2, &_r3, &_r4, &_r5, &_r6);
    *_d_e_new += _r1;
    *_d_compHalfStep += _r2;
    *_d_vnewc += _r3;
    *_d_pmin += _r4;
...
__attribute__((device)) __attribute__((always_inline)) static inline void
CalcSoundSpeedForElems_device_pullback(
    Real_t vnewc, Real_t rho0, Real_t enewc, Real_t pnewc, Real_t pbvc,
    Real_t bvc, Real_t ss4o3, Index_t nz, const Real_t* __restrict ss,
    Index_t iz, Real_t* _d_vnewc, Real_t* _d_rho0, Real_t* _d_enewc,
    Real_t* _d_pnewc, Real_t* _d_pbvc, Real_t* _d_bvc, Real_t* _d_ss4o3,
    Index_t* _d_nz, Real_t* _d_ss, Index_t* _d_iz) {
  bool _cond0;
  Real_t _t0;
  Real_t _d_ssTmp = 0.;
  ...
  }
  {
    ...
    *_d_pnewc += vnewc * vnewc * bvc * _d_ssTmp / rho0;
    Real_t _r0 = _d_ssTmp * -((pbvc * enewc + vnewc * vnewc * bvc * pnewc) /
                              (rho0 * rho0));
    *_d_rho0 += _r0;
  }
}
__attribute__((device)) __attribute__((always_inline)) static inline void
UpdateVolumesForElems_device_pullback(Index_t numElem, Real_t v_cut,
                                      const Real_t* vnew, const Real_t* v,
                                      int i, Index_t* _d_numElem,
                                      Real_t* _d_v_cut, Real_t* _d_vnew,
                                      Real_t* _d_v, int* _d_i) {
  bool _cond0;
  Real_t _t0;
  Real_t _d_tmpV = 0.;
  Real_t tmpV;
...
ApplyMaterialPropertiesForElems_device_pullback(
    ...
    const Real_t* __restrict v, Real_t& vnewc,
    const Index_t* __restrict bad_vol, Index_t zn, Real_t* _d_eosvmin,
    Real_t* _d_eosvmax, Real_t* _d_vnewc, Index_t* _d_zn);
__attribute__((device)) inline void
giveMyRegion_pullback(const Index_t* regCSR, const Index_t i,
                      const Index_t numReg, Index_t _d_y, Index_t* _d_i,
                      Index_t* _d_numReg);
__attribute__((device)) __attribute__((always_inline)) static inline void
CalcSoundSpeedForElems_device_pullback(
    Real_t vnewc, Real_t rho0, Real_t enewc, Real_t pnewc, Real_t pbvc,
    ...
    Index_t iz, Real_t* _d_vnewc, Real_t* _d_rho0, Real_t* _d_enewc,
    Real_t* _d_pnewc, Real_t* _d_pbvc, Real_t* _d_bvc, Real_t* _d_ss4o3,
    Index_t* _d_nz, Index_t* _d_iz);
__attribute__((device)) __attribute__((always_inline)) static inline void
UpdateVolumesForElems_device_pullback(Index_t numElem, Real_t v_cut,
                                      const Real_t* vnew, const Real_t* v,
                                      int i, Index_t* _d_numElem,
                                      Real_t* _d_v_cut, int* _d_i);
...
Inner_ApplyMaterialPropertiesAndUpdateVolume_kernel_grad_14(
  ...
  Real_t _d_e_old = 0., _d_delvc = 0., _d_p_old = 0., _d_q_old = 0.,
         _d_e_temp = 0., _d_delvc_temp = 0., _d_p_temp = 0., _d_q_temp = 0.;
  ...
  Real_t _d_qq_old = 0., _d_ql_old = 0., _d_qq_temp = 0., _d_ql_temp = 0.,
         _d_work = 0.;
    ...
    if (_cond0) {
      ...
      for (r = 0;; r++) {
        ...
        CalcEnergyForElems_device(p_new, e_new, q_new, bvc, pbvc, p_old, e_old,
                                  ...
                                  delvc, pmin, p_cut, e_cut, q_cut, emin,
  ...
  if (_cond0) {
    {
      ...
      Real_t _r35 = 0.;
      Index_t _r36 = 0;
      UpdateVolumesForElems_device_pullback(length, v_cut, vnew, v, zidx, &_r34,
                                            &_r35, &_r36);
      _d_length += _r34;
      _d_v_cut += _r35;
      _d_zidx += _r36;
    }
    {
      ...
      Index_t _r33 = 0;
      CalcSoundSpeedForElems_device_pullback(
          vnewc, rho0, e_new, p_new, pbvc, bvc, ss4o3, length, ss, zidx, &_r25,
          &_r26, &_r27, &_r28, &_r29, &_r30, &_r31, &_r32, &_r33);
      _d_vnewc += _r25;
      _d_rho0 += _r26;
      _d_e_new += _r27;
      _d_p_new += _r28;
    ...
    for (;; _t3--) {
      ...
      }
      {
        ...
        CalcEnergyForElems_device_pullback(
            ...
            compHalfStep, vnewc, work, delvc, pmin, p_cut, e_cut, q_cut, emin,
            qq_old, ql_old, rho0, eosvmax, length, &_d_p_new, &_d_e_new,
            &_d_q_new, &_d_bvc, &_d_pbvc, &_r7, &_r8, &_r9, &_r10, &_r11, &_r12,
            &_r13, &_r14, &_r15, &_r16, &_r17, &_r18, &_r19, &_r20, &_r21,
            &_r22, &_r23, &_r24);
        // clad::pop(_t13);
        // clad::pop(_t14);
        // clad::pop(_t15);
    ...
    }
    {
      ...
      Real_t _r1 = 0.;
      Index_t _r2 = 0;
      ApplyMaterialPropertiesForElems_device_pullback(eosvmin, eosvmax, vnew, v,
                                                      _t2, bad_vol, zidx, &_r0,
                                                      &_r1, &_d_vnewc, &_r2);
      _d_eosvmin += _r0;
      _d_eosvmax += _r1;
      _d_zidx += _r2;
